...
void main(void)
{
    ...
    EUSCI_B0->CTLW0 = (EUSCI_B_CTLW0_SWRST | EUSCI_B_CTLW0_MST | EUSCI_B_CTLW0_MODE_3 | EUSCI_B_CTLW0_SSEL__SMCLK);
    ...
    EUSCI_B0->BRW = (uint16_t) (3000 / 100000);
    ...
    uint32_t baseAddress = (uint32_t) P1;
    ...
    I2C_setSlaveAddress(EUSCI_B0_BASE, TMP_ADDR);

    /* Enable I2C Module to start operations */
    EUSCI_B0->CTLW0 &= ~EUSCI_B_CTLW0_SWRST;

    EUSCI_B_CMSIS(EUSCI_B0_BASE)->IFG = 0;

    //Enable the interrupt masked bit
//    EUSCI_B_CMSIS(EUSCI_B0_BASE)->IE |= EUSCI_B_I2C_RECEIVE_INTERRUPT0 + EUSCI_B_I2C_TRANSMIT_INTERRUPT0 + EUSCI_B_I2C_NAK_INTERRUPT;
...
//    memset(RXData, 0x00, NUM_RX_BYTES);
    ...
    I2C_send(EUSCI_B0_BASE, TXData, NUM_TX_BYTES);
    I2C_send(EUSCI_B0_BASE, &TMP_REG, 1);


    I2C_receive(EUSCI_B0_BASE, RXData, NUM_RX_BYTES);
